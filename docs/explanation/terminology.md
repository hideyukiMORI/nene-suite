...
| Federation signing private key | `NENE_SUITE_FEDERATION_PRIVATE_KEY` | `FEDERATION_PRIVATE_KEY`, `NENE_SUITE_FED_KEY`, `JWKS_PRIVATE_KEY` |
| Federation signing private key file | `NENE_SUITE_FEDERATION_PRIVATE_KEY_FILE` | `FEDERATION_PRIVATE_KEY_FILE`, `NENE_SUITE_FED_KEY_FILE` |
...
| Trusted reverse-proxy CIDRs | `NENE_SUITE_TRUSTED_PROXIES` | `TRUSTED_PROXIES`, `NENE_SUITE_PROXY`, `FORWARDED_FOR_TRUST` |
