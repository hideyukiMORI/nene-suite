...
**Status:** Phase 1 implements the first vertical slice — catalog read, install
session lifecycle, env generation, manifest write, audit recording — following
these rules from the first commit.
