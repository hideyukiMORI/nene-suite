...
final class JwtSecretResolverTest extends TestCase
{
    ...
    {
        $resolver = new JwtSecretResolver('a-real-random-secret', '');
    ...
    {
        $resolver = new JwtSecretResolver('a-real-random-secret', '1');
    ...
    {
        $resolver = new JwtSecretResolver('', $optIn);
    ...
    {
        $resolver = new JwtSecretResolver('', '');
